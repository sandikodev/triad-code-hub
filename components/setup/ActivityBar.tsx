    ...
    <aside className="w-16 bg-[#040712] border-r border-white/5 flex flex-col items-center py-8 shrink-0 hidden md:flex">
      <div className="flex-1 flex flex-col items-center gap-8">
        <button 
          ...
          className={`p-3.5 rounded-2xl transition-all ${activeSidebarTab === 'files' ? 'text-indigo-400 bg-indigo-500/10 shadow-[0_0_15px_rgba(99,102,241,0.2)]' : 'text-slate-600 hover:text-slate-400'}`}
        >
        ...
        <button 
          ...
          data-tooltip="Pencarian Global"
          className={`p-3.5 rounded-2xl transition-all ${activeSidebarTab === 'search' ? 'text-indigo-400 bg-indigo-500/10' : 'text-slate-600 hover:text-slate-400'}`}
        >
        ...
        <button 
          ...
          className={`p-3.5 rounded-2xl transition-all ${activeSidebarTab === 'git' ? 'text-indigo-400 bg-indigo-500/10' : 'text-slate-600 hover:text-slate-400'}`}
        >
        ...
        <button 
          data-tooltip="Extensions Lab"
          className="p-3.5 rounded-2xl text-slate-600 hover:text-slate-400 transition-all"
        >
